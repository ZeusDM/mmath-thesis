...
\todo{This figure could be improved, especially in regard to equal entries.}
...
\todo{Add alternative description of \(\inv(T)\) and \(\coinv(T)\) in terms of inversion pairs.}
...
However, they behave differently for the definition of the south of a box.
